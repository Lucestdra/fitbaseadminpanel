...
export default function RootLayout() {
  return (
    <SafeAreaProvider>
      ...
      {/*
        Outermost of the three, so a notice can be raised from anywhere — including the auth
        screens, which are outside AppShell and used to have nowhere to put one.
      */}
      <ToastProvider>
        <AuthProvider>
          {/*
          ...
          */}
          <BootstrapGate>
            {/*
              ...
              passing them on — and the context that held them in memory could only ever describe
              the current session's edits.
            */}
            <CatalogsProvider>
